...
describe("DemoShell", () => {
  ...
  it("manually toggles before and after outside the phone", async () => {
    ...
    render(<App />);
    expect(screen.getByAltText("Trust friction before screenshot")).toBeInTheDocument();
  ...
  it("updates narrative copy when feature changes", async () => {
    ...
    expect(screen.getByAltText("Community engagement friction before screenshot")).toBeInTheDocument();
  });
});
